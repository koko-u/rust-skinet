...
(
    ...
    CONSTRAINT "product_type_fkey" FOREIGN KEY ("product_type_id") REFERENCES "product_types" ("id") ON DELETE CASCADE,
    CONSTRAINT "product_brand_fkey" FOREIGN KEY ("product_brand_id") REFERENCES "product_brands" ("id") ON DELETE SET NULL
);
...
CREATE INDEX "product_brand_idx" ON "products" ("product_brand_id");
